...
export const pagesTypeEnum = pgEnum('page_type', [
  'facebook',
  'instagram',
  'snapchat',
]);
export const oauthEnum = pgEnum('oauth_provider', [
  'normal',
  'google',
  'facebook',
]);
...
export const adminImpressionRatio = pgTable('admin_impression_ratio', {
  ...
  impressionsPerUnit: integer('impressions_per_unit').notNull(),
...
export const socialMediaPagesRelations = relations(
  socialMediaPages,
  ({ one, many }) => ({
    user: one(users, {
